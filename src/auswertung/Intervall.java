...
public class Intervall {
	...
	private Stempelung anfangsStempel;
	private Stempelung endStempel;
	private String vonBis;
	private Stempelung[] einzelStempelung;
	...
	private void bereinige()
	{
		...
		int i = 0;
		int j = 0;
		//System.out.println("einzelstemplung.length: "+ einzelStempelung.length + " Nullzaehler: "+nullzaehler);
